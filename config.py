...
# 🔑 MAXFIY KALITLAR VA TOKENLAR (To'g'ridan-to'g'ri shu yerda saqlanadi)
...
FLOOD_RATE       = 1.5   # Spamga qarshi cheklov (soniya)
BAN_THRESHOLD    = 5     # Necha marta flood qilsa banga tushadi
MAX_FILE_MB      = 45    
